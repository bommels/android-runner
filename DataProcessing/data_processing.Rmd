...
# TODO add title
# FIXME Filter on device type?
bp <- ggplot(app_data, aes(x = app, y = Joule_calculated)) +
  theme_bw() +
  xlab("App") + ylab("Joules") +
  ylim(c(0, 500)) +
  geom_violin(trim = FALSE, alpha = 0.5) +
  geom_boxplot(color = 'red', width = .2, fill = 'white', outlier.size = .5) +
  stat_summary(fun = mean, color = 'black', geom = 'point', shape = 5, size = 2, show.legend = F) +
  theme(
